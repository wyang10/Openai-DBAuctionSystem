# Generated by Django 3.1.7 on 2023-11-16 04:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ename', models.CharField(blank=True, max_length=18, null=True)),
                ('zip', models.CharField(blank=True, max_length=6, null=True)),
        ...
        migrations.CreateModel(
            name='Orders',
            fields=[
                ('ono', models.IntegerField(blank=True, primary_key=True, serialize=False)),
                ('cno', models.IntegerField(blank=True, null=True)),
                ('eno', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('auctions', models.ManyToManyField(blank=True, related_name='auctions_in_watchlist', to='dbapp.Auction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auction_comments', to='dbapp.auction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auction_bids', to='dbapp.auction')),
        ...
        migrations.AddField(
            model_name='auction',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auction_category', to='dbapp.category'),
        ),
        migrations.AddField(
            model_name='auction',
            name='seller',
